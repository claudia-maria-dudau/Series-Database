...
-- Sa se afiseze pentru un producator specificat fiecare serial  pe care il produce
-- si lista actorilor impreuna cu personajele pe care le interpreteaza in respectivul serial
CREATE OR REPLACE PROCEDURE afisare_seriale_producator
...
-- merge
EXECUTE afisare_seriale_producator('Eric', 'Kripke');

-- merge
EXECUTE afisare_seriale_producator('Julie');

-- merge
EXECUTE afisare_seriale_producator(null, 'Kapinos');

-- nume si prenumele sunt ambele null => nu merge
EXECUTE afisare_seriale_producator();
